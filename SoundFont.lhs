...
>     wiFolder accum pergmI                = foldl' (xaEnterTournament (getProAndCon iMatches) pergmI []) accum as'
>       where
...
>         laden wZones
>           | null zs                      = 0
>           | otherwise                    = (fromIntegral . length) wZones / (fromIntegral . length) zs
>
