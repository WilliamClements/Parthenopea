...
> g008 = line [d 5 hn, descent AcousticGuitarSteel (D, 5) dqn, grace (-1) (d 6 en)]
>
...
> g026 = line [descent AcousticGuitarSteel (E, 3) dhn, tempo (5/4) (line [rest en, fs 4 en, fs 4 sn])]
...
> g032 = line [g 4 en, fs 4 en, descent AcousticGuitarSteel (Fs, 4) hn, rest qn]
>
...
> g036 = line [e 4 en, ascent AcousticGuitarSteel (D, 4) dqn, rest dqn, tempo (3/2) (line [e 5 en, e 5 sn])]
>
...
>
> g037 = line [grace 2 (c 5 en), fs 4 sn, g 4 sn, tempo (3/2) (line [g 4 sn, fs 4 sn, d 4 sn, fs 4 en, fs 4 sn])
>            , tempo (3/2) (line [e 4 en, e 4 en, fs 4 en, fs 4 en, tempo (3/2) (line [e 4 sn, fs 4 sn, e 4 sn]), d 4 en])]
...
>            , tempo (3/2) (line [chord [perc SplashCymbal en, percBDen], percLTen, chord [perc SplashCymbal en, percBDen]])
>            , tempo (3/2) (line [chord [perc SplashCymbal en, percLTen], times 2 (chord [perc SplashCymbal en, percLTen, percBDen])])]
>
...
> g070 = line [e 6 en, e 6 en, tempo (3/2) (line [e 6 sn, fs 6 sn, e 6 sn]), descent AcousticGuitarSteel (D, 6) dqn
...
>            , tempo (3/2) (line [chord [percRCen, percLTen, percBDen], chord [percRCen, percLTen], percLTsn, percLTsn])]
>
...
> m083 = line [chord [perc CrashCymbal1 qn, perc BassDrum1 qn], chord [percRCen, percBDen], chord [percRCen, percBDen]
...
> m087 = line [chord [percRCen, percBDen], percLTsn, percLTsn, rest sn, percLTsn, chord [percRCsn, percBDsn], percBDsn
...
>            , percRCen
>            , tempo (7/4) (line [percm LowTom [en, en, en, en], chord [percm RideCymbal1 [qn, en], percm BassDrum1 [qn, en]]])]
> m094 =
>   line [
...
>          , chord [perc RideCymbal1 qn, perc LowTom qn, perc BassDrum1 qn], chord [perc RideCymbal1 qn, perc LowTom qn]
>          , perc LowTom qn, rest qn])
>      , chord [percRCsn, percLTsn, percBDsn], percLTsn, percLTen, rest en
>      , chord [percRCsn, percLTsn, percBDsn], chord [percRCsn, percLTsn], chord [perc RideCymbal1 qn, perc LowTom qn]  
>        ]
...
>            , chord [percCCsn, percBDsn]
>            , t32 [chord [percCCsn, percLTsn, percBDsn], percm LowTom [sn, sn, sn, sn, sn, sn, sn, sn, sn, sn, sn]]]
...
> g119 = line [e 5 sn, e 5 sn, d 5 sn, ascent AcousticGuitarSteel (D, 5) (sn + dhn)]
...
>            , tempo (5/4) (line [chord [percCCen, percLTen], chord [percCCsn, percLTsn], chord [percCCen, percLTen]])
...
> g123 = line [fs 4 en, chord [fs 3 qn, fs 4 qn], a 6 en, descent AcousticGuitarSteel (A, 6) qn, rest en, e 4 en]
...
>            , grace (-1) (g 6 en), descent AcousticGuitarSteel (G, 6) en]
...
>     , addDur tn [es 4, fs 4, es 4, fs 4, es 4, e 4, d 4, c 4], ascent AcousticGuitarSteel (D, 4) qn]
>        
> g143 =
>   line [
>     tempo (5/4) (
...
>
> g157 = line [descent AcousticGuitarSteel (D, 6) qn, t32 [rest qn, e 5 en, g 5 en, a 5 en, rest en]
>            , grace (-1) (f 6 qn)]
...
>            , chord [descent AcousticGuitarSteel (A, 5) en, descent AcousticGuitarSteel (C, 6) en, descent AcousticGuitarSteel (Fs, 6) en]
...
> g194 = line [chord [descent AcousticGuitarSteel (Fs, 5) dqn, descent AcousticGuitarSteel (A, 5) dqn, descent AcousticGuitarSteel (D, 6) dqn]
...
>
> v202 = line [descent ChoirAahs (Fs, 5) dqn, d 5 en, d 5 (wn + qn), rest qn]
...
> g202 = line [chord [descent AcousticGuitarSteel (Fs, 5) dqn, descent AcousticGuitarSteel (A, 5) dqn, descent AcousticGuitarSteel (D, 6) dqn]
