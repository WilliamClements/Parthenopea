...
>    g008 = line [d 5 hn, descent sunPygLead (D, 5) D chromatic dqn, grace (-1) (d 6 en)]
>   
...
>    g026 = line [ascent sunPygLead (E, 3) E chromatic dhn, tempo (5/4) (line [rest en, fs 4 en, fs 4 sn])]
...
>    g032 = line [g 4 en, fs 4 en, descent sunPygLead (Fs, 4) Fs chromatic hn, rest qn]
>   
...
>    g036 = line [e 4 en, ascent sunPygLead (D, 4) D chromatic dqn, rest dqn, tempo (3/2) (line [e 5 en, e 5 sn])]
>   
...
>    g070 = line [e 6 en, e 6 en, tempo (3/2) (line [e 6 sn, fs 6 sn, e 6 sn]), descent sunPygLead (D, 6) D chromatic dqn
...
>    g078 = line [grace (-1) (g 4 en), fs 4 (en + hn), descent sunPygLead (D, 6) D chromatic qn]
...
>    g098 = line [descent sunPygLead (C, 6) C chromatic en, d 4 sn, d 4 sn, g 4 sn, g 4 sn, g 4 en, g 4 en, a 4 en, a 4 en
>               , t32 [b 4 en, c 5 sn]]
...
>        , d 5 qn, descent sunPygLead (D, 6) D chromatic qn]
>   
...
>    g119 = line [e 5 sn, e 5 sn, d 5 sn, ascent sunPygLead (D, 5) D chromatic (sn + dhn)]
...
>    g123 = line [fs 4 en, chord [fs 3 qn, fs 4 qn], a 6 en, descent sunPygLead (A, 6) A chromatic qn, rest en, e 4 en]
...
>               , grace (-1) (g 6 en), descent sunPygLead (G, 6) G chromatic en]
...
>        , addDur tn [es 4, fs 4, es 4, fs 4, es 4, e 4, d 4, c 4], ascent sunPygLead (D, 4) D chromatic qn]
>           
>    g143 =
>      line [
>        tempo (5/4) (
...
>               , descent sunPygLead (D, 6) D chromatic en, t32 [rest en, grace (-2) (d 4 en), df 4 en]]
...
>   
>    g157 = line [descent sunPygLead (D, 6) D chromatic qn, t32 [rest qn, e 5 en, g 5 en, a 5 en, rest en]
>               , grace (-1) (f 6 qn)]
...
>               , chord [descent sunPygLead (A, 5) A chromatic en
>                      , descent sunPygLead (C, 6) C chromatic en
>                      , descent sunPygLead (Fs, 6) Fs chromatic en]
...
>   
>    g189 = line [t32 [descent sunPygLead (A, 6) A chromatic qn, chord [d 6 en, g 6 en]], chord [g 4 en, c 5 en, e 5 en]
...
>    g194 = line [chord [descent sunPygLead (Fs, 5) Fs chromatic dqn
>                      , descent sunPygLead (A, 5) A chromatic dqn
>                      , descent sunPygLead (D, 6) D chromatic dqn]
...
>   
>    v202 = line [descent sunPygChoir (Fs, 5) Fs chromatic dqn, d 5 en, d 5 (wn + qn), rest qn]
...
>    g202 = line [chord [descent sunPygLead (Fs, 5) Fs chromatic dqn
>                      , descent sunPygLead (A, 5) A chromatic dqn
>                      , descent sunPygLead (D, 6) D chromatic dqn]
