...
> g008 = line [d 5 hn, descent (D, 5) dqn, grace (-1) (d 6 en)]
>
...
> g026 = line [descent (E, 3) dhn, tempo (5/4) (line [rest en, fs 4 en, fs 4 sn])]
...
> g032 = line [g 4 en, fs 4 en, descent (Fs, 4) hn, rest qn]
>
...
> g036 = line [e 4 en, ascent (D, 4) dqn, rest dqn, tempo (3/2) (line [e 5 en, e 5 sn])]
>
...
> g070 = line [e 6 en, e 6 en, tempo (3/2) (line [e 6 sn, fs 6 sn, e 6 sn]), descent (D, 6) dqn
...
> g078 = line [grace (-1) (g 4 en), fs 4 (en + hn), descent (D, 7) qn]
...
> g098 = line [descent (C, 6) en, d 4 sn, d 4 sn, g 4 sn, g 4 sn, g 4 en, g 4 en, a 4 en, a 4 en
>            , t32 [b 4 en, c 5 sn]]
...
> g119 = line [e 5 sn, e 5 sn, d 5 sn, ascent (D, 5) (sn + dhn)]
...
> g123 = line [fs 4 en, chord [fs 3 qn, fs 4 qn], a 6 en, descent (A, 6) qn, rest en, e 4 en]
...
>     , addDur tn [es 4, fs 4, es 4, fs 4, es 4, e 4, d 4, c 4], ascent (D, 4) qn]
>        
> g143 =
>   line [
>     tempo (5/4) (
...
>            , descent (D, 7) en, t32 [rest en, grace (-2) (d 4 en), df 4 en]]
...
>
> g157 = line [descent (D, 6) qn, t32 [rest qn, e 5 en, g 5 en, a 5 en, rest en]
>            , grace (-1) (f 6 qn)]
...
>            , chord [descent (A, 5) en, descent (C, 6) en, descent (Fs, 6) en]
...
>
> g189 = line [t32 [descent (A, 7) qn, chord [d 6 en, g 6 en]], chord [g 4 en, c 5 en, e 5 en]
...
> g194 = line [chord [descent (Fs, 5) dqn, descent (A, 5) dqn, descent (D, 6) dqn]
...
>
> v202 = line [descent (Fs, 5) dqn, d 5 en, d 5 (wn + qn), rest qn]
...
> g202 = line [chord [descent (Fs, 5) dqn, descent (A, 5) dqn, descent (D, 6) dqn]
