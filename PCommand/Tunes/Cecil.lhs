...
> cecilTranspose                           = 0
>
> cecilAlto, cecilTenor, cecilBass
>                        :: BandPart
> cecilAlto                                = makePitched Violin        cecilTranspose      0        100
> cecilTenor                               = makePitched TenorSax      cecilTranspose      0        100
> cecilBass                                = makePitched AcousticBass  cecilTranspose      0        100
>
> cecil                  :: Music (Pitch, [NoteAttribute])
> cecil                                    =
>    removeZeros
>    $ tempo cecilTempo
>    $ keysig G Dorian
...
>
> abbyGrand              :: BandPart
> abbyGrand                                = makePitched AcousticGrandPiano abbyTranspose 0 100
>
> abby                   :: Music (Pitch, [NoteAttribute])
> abby                                     =
>    removeZeros
>    $ tempo abbyTempo
>    $ keysig C Major
...
> wjTranspose                              = 0
>
> wjAlto, wjTenor, wjBass
>                        :: BandPart
> wjAlto                                   = makePitched AltoSax               wjTranspose 0           100
> wjTenor                                  = makePitched ReedOrgan             wjTranspose 0           75
> wjBass                                   = makePitched ElectricBassFingered  wjTranspose 0           100
>
> wj                     :: Music (Pitch, [NoteAttribute])
> wj                                       =
>    removeZeros
>    $ tempo wjTempo
>    $ keysig G Dorian
