...
> ffTransposeCap                           = 0
>
> theFanfare             :: Bool → Music (Pitch, [NoteAttribute])
> theFanfare isCap                         =
>              removeZeros
>              $ tempo fgTempo
>              $ keysig C Mixolydian
...
>
>       ffLeadI                            = makePitched Trumpet      xpo 0            80
>       ffLeadII                           = makePitched Flute        xpo 0            80
>       ffPickedI                          = makePitched Trombone     xpo 0           110
>
...
> aliceTranspose                           = 10
> aliceLead             :: BandPart
> aliceLead                                = makePitched Vibraphone aliceTranspose 0 100
>
> alice                 :: Music (Pitch, [NoteAttribute])
> alice                                    =
>         removeZeros
>         $ tempo                          aliceTempo
>         $ keysig G Dorian
...
> bobTranspose                             = 0
>
> bobTreble, bobAlto, bobBass
>                        :: BandPart
> bobTreble                                = makePitched Violin        bobTranspose 0 100
> bobAlto                                  = makePitched Oboe          bobTranspose 0  70
> bobBass                                  = makePitched Cello         bobTranspose 0  50
>
> bob :: Int → Music (Pitch, [NoteAttribute])
> bob nRepeats                             =
>       removeZeros
>       $ tempo bobTempo
>       $ keysig D Mixolydian
...
> billTranspose                            = 0
>
> billTreble, billAlto, billBass
>                        :: BandPart
> billTreble                               = makePitched Violin              billTranspose 0  80
> billAlto                                 = makePitched RhodesPiano         billTranspose 0 110
> billBass                                 = makePitched Cello               billTranspose 0  60
>
> bill                   :: Int → Music (Pitch, [NoteAttribute])
> bill nRepeats                            =
>    removeZeros
>    $ tempo     billTempo
...
>
> copperLead             :: BandPart
> copperLead                               = makePitched Banjo copperTranspose 0 100
>
> copper                 :: Int → Music (Pitch, [NoteAttribute])
> copper n                                 =
>    removeZeros
>    $ tempo copperTempo
>    $ keysig C Dorian
...
>
> goldLead               :: BandPart
> goldLead                                 = makePitched AcousticGrandPiano goldTranspose 0 100
>
> gold                   :: Music (Pitch, [NoteAttribute])
> gold                                     =
>    removeZeros
>    $ tempo goldTempo
>    $ keysig C Mixolydian
...
>
> silverLead             :: BandPart
> silverLead                               = makePitched OrchestralHarp silverTranspose 0 100
>     
> silver                 :: Music (Pitch, [NoteAttribute])
> silver                                   =
>     removeZeros
>     $ tempo silverTempo
>     $ keysig A Mixolydian
...
> snakeTranspose                           = 0
>
> snakeLead, snakeSecond :: BandPart
> snakeLead                                = makePitched    AltoSax    snakeTranspose  0  100
> snakeSecond                              = makePitched    TenorSax   snakeTranspose  0  100
>
> snake                  :: Music (Pitch, [NoteAttribute])
> snake                                    =
>    removeZeros
>    $ tempo snakeTempo
>    $ keysig D Mixolydian
...
> citmTranspose                           = 0
>
> citmLead, citmStrum, citmBass
>                        :: BandPart
> citmLead                                 = makePitched AltoSax               citmTranspose 0 100
> citmStrum                                = makePitched ElectricGuitarJazz    citmTranspose 0 100
> citmBass                                 = makePitched ElectricBassFingered  citmTranspose 0 100
>
> getCITM                :: Music (Pitch, [NoteAttribute])
> getCITM                                  =
>    removeZeros
>    $ tempo citmTempo
>    $ keysig G Major
...
> wnTranspose                              = 4
>
> wnLead, wnStrings, wnBass, wnPerc
>                        :: BandPart
> wnLead                                   = makePitched    AltoSax              wnTranspose 0 90
> wnStrings                                = makePitched    AcousticGuitarNylon  wnTranspose 0 90
> wnBass                                   = makePitched    ElectricBassPicked   wnTranspose 0 80
> wnPerc                                   = makeNonPitched                                    100
>
> whelpNarp              :: Music (Pitch, [NoteAttribute])
> whelpNarp                                =
>    removeZeros
>    $ tempo wnTempo
>    $ keysig C Mixolydian
...
> rogerTranspose                           = 0
>
> rogerAlto, rogerTenor  :: BandPart
> rogerAlto                                = makePitched Flute               rogerTranspose 12 100
> rogerTenor                               = makePitched AcousticGuitarNylon rogerTranspose  0 100
>
> roger :: Music (Pitch, [NoteAttribute])
> roger                                    =
>    removeZeros
>    $ tempo                               rogerTempo
>    $ keysig Cs Dorian
...
> wayposTranspose                          = 0
>
> wayposLead, wayposStrum, wayposBass, wayposPerc
>                        :: BandPart
> wayposLead                               = makePitched    Clarinet       wayposTranspose 0 100
> wayposStrum                              = makePitched    OrchestralHarp wayposTranspose 0 100
> wayposBass                               = makePitched    SynthBass1     wayposTranspose 0  50
> wayposPerc                               = makeNonPitched                                  100
>
> waypostpurple          :: Music (Pitch, [NoteAttribute])
> waypostpurple                            =
>    removeZeros
>    $ tempo                               wayposTempo
>    $ keysig C Major
...
> pArntTranspose                          = 0
>
> pArntLead, pArntStrum, pArntBass
>                        :: BandPart
> pArntLead                               = makePitched TenorSax               pArntTranspose 0 100
> pArntStrum                              = makePitched AcousticGuitarNylon    pArntTranspose 0 100
> pArntBass                               = makePitched Cello                  pArntTranspose 0 100
>
> pendingtonArnt         :: Int → Music (Pitch, [NoteAttribute])
...
> panTranspose                          = 0
>
> panLead, panStrum, panBass
>                        :: BandPart
> panLead                                  = makePitched AltoSax                panTranspose 0 100
> panStrum                                 = makePitched AcousticGuitarSteel    panTranspose 0 100
> panBass                                  = makePitched AcousticBass           panTranspose 0 100
>
> pan                    :: Music (Pitch, [NoteAttribute])
> pan                                      =
>     removeZeros
>     $ tempo panTempo
...
> ratTranspose                             = 0
>
> ratLead, ratBass, ratPerc
>                        :: BandPart
> ratLead                                  = makePitched AltoSax         ratTranspose 0 100
> ratBass                                  = makePitched SynthBass1      ratTranspose 0 100
> ratPerc                                  = makeNonPitched                             100
> 
> rattan                 :: Music (Pitch, [NoteAttribute])
> rattan                                   =
>     removeZeros
>     $ tempo ratTempo
>     $ keysig E Locrian
...
> kitTranspose                             = 0
>
> kitLead, kitPerc       :: BandPart
> kitLead                                  = makePitched FrenchHorn kitTranspose 0 100
> kitPerc                                  = makeNonPitched                        100
>
> kit                    :: Music (Pitch,[NoteAttribute])
> kit                                      =
>   removeZeros
>   $ tempo kitTempo
...
> pitTranspose                             = 0
>
> pitLead, pitStrum, pitBass
>                        :: BandPart
> pitLead                                  = makePitched EnglishHorn           pitTranspose 0 100
> pitStrum                                 = makePitched AcousticGuitarSteel   pitTranspose 0 100
> pitBass                                  = makePitched SynthBass1            pitTranspose 0 100
>
> pit                    :: Music (Pitch, [NoteAttribute])
> pit                                      =
>   removeZeros
>   $ tempo pitTempo
>   $ keysig B Lydian
...
>
> ditBass                :: BandPart
> ditBass                                  = makePitched Trombone ditTranspose 0 100
>
> dit                    :: Music (Pitch, [NoteAttribute])
> dit                                      = 
>   removeZeros
>   $ tempo ditTempo
>   $ keysig Af Mixolydian
...
>
>   ditbody2                               =
>     line [bendNote ditBass Ds 4 den (-12), bendNote ditBass Ds 3 sn 0,     bendNote ditBass Ds 4 den 0
>         , bendNote ditBass E 4 sn 0,       bendNote ditBass Ds 4 den (-2), bendNote ditBass Ds 4 sn 0]
>
>   ditbody3                               =
...
>
> da4Lead                :: BandPart
> da4Lead                                  = makePitched AltoSax da4Transpose 0 100
>
> dadadada               :: Directives → Music (Pitch, [NoteAttribute])
> dadadada dives                           =
>   removeZeros
>   $ tempo da4Tempo
>   $ keysig Af Mixolydian
>   $ orchestraPart da4Lead (times 2 body)
>
>   where
>
>   body = passage
...
> d3Transpose                              = 0
>
> d3Lead, d3LeadQ, d3Bass, d3BassQ
>                         :: BandPart
> d3Lead                                   = makePitched Violin               d3Transpose          0        100
> d3LeadQ                                  = makePitched Violin               d3Transpose          0         75
> d3Bass                                   = makePitched SynthBass2           d3Transpose          0         90
> d3BassQ                                  = makePitched SynthBass2           d3Transpose          0         60
>
> deyDumpDum             :: Bool → Music (Pitch, [NoteAttribute])
> deyDumpDum cap                           =
>   removeZeros
...
>              , cs 4 wn, rest den, e 4 sn, a 3 en, rest en, c 4 en, rest en, b 3 en, rest en
>              , a 3 (wn + hn), rest den, e 4 sn, cs 4 en, rest en
>              , d 4 wn, rest den, fs 4 sn, a 4 en, rest en, fs 4 en, rest en, f 4 en, rest en
>              , e 4 wn
...
>
>   bIa                  = line [a 2 hn, e 2 hn, a 2 hn,  e 2 hn, a 2 hn, e 2 hn, a 1 hn, cs 2 hn]
>   bIb                  = line [d 2 hn, a 2 hn, d 2 hn, fs 2 hn, a 2 hn, e 2 hn, a 1 hn, cs 2 hn]
>   bIc                  = line [e 2 hn, b 2 hn, e 2 hn,  b 2 hn, a 2 hn, e 2 hn, a 1 hn, rest hn]
>
